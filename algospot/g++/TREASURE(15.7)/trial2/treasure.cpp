...
void get_input(){
    scanf("%lf %lf %lf %lf %d", &iX1, &iY1, &iX2, &iY2, &N);
    for(int i=0; i<N; ++i)
...
void solve(){
    ...
    polygon ret = vec2::cut_polygon(poly,v1,v2);
    ret = vec2::cut_polygon(ret,v2,v3);
    ret = vec2::cut_polygon(ret,v3,v4);
    ret = vec2::cut_polygon(ret,v4,v1);
