...
(gdb) x/10x $rax
0x401578 <_ZTV3Man+24>: 0x004012d2      0x00000000      0x00000000      0x00000000
0x401588 <_ZTV5Human+8>:        0x004015f0      0x00000000      0x0040117a      0x00000000
0x401598 <_ZTV5Human+24>:       0x00401192      0x00000000

~~~

pointer를 갖고온다
pointer를 dereference한다 (rax에는 table의 시작점이 들어간다)
table+8 한다
...
~~~
                             ...
                             * Human::give_shell()                                        *
                             **************************************************************
                             undefined __stdcall give_shell(void)
             undefined         AL:1           <RETURN>
             undefined8        Stack[-0x10]:8 local_10                                XREF[1]:     00401182(W)  
                             _ZN5Human10give_shellEv                         XREF[6]:     Entry Point(*), 00401550(*), 
                             Human::give_shell                                            00401570(*), 00401590(*), 
                                                                                          0040162c, 004016c8(*)  
        0040117a 55              PUSH       RBP
        0040117b 48 89 e5        MOV        RBP,RSP
        0040117e 48 83 ec 10     SUB        RSP,0x10
        00401182 48 89 7d f8     MOV        qword ptr [RBP + local_10],RDI
        00401186 bf a8 14        MOV        EDI=>s_/bin/sh_004014a8,s_/bin/sh_004014a8       = "/bin/sh"
                 40 00
        0040118b e8 30 fb        CALL       system                                           int system(char * __command)
                 ff ff
        00401190 c9              LEAVE
        00401191 c3              RET
